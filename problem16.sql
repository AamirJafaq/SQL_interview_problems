...
*/
-- Solution
WITH ranking AS (SELECT c.city_id, c.city_name, r.restaurant_id, r.restaurant_name, ROUND(avg(o.rating),1) AS avg_rating, 
	ROW_NUMBER() OVER(PARTITION BY c.city_id ORDER BY ROUND(avg(o.rating),1) DESC) AS rank
